        ...
        <div className="h-full overflow-y-auto">
            <div className="p-4 space-y-4">
                <Button
                    ...
                    className={
                        "w-full py-3 px-4 bg-purple-600 hover:bg-purple-700 text-white rounded-md flex items-center justify-center transition-colors"
                    }
                >
                ...
                <div className="pt-2">
                    ...
                    <div className="space-y-4">
                        {textPresets.map((preset, index) => (
                            <button
                                key={index}
                                className="w-full text-left p-3 bg-white border border-gray-200 rounded-md hover:bg-gray-500 transition-colors"
                                style={{
                                    fontSize: `${Math.min(
                                        preset.fontSize / 1.8,
                                        24
